...
<head>
    ...
    <title data-translate="pageTitle">صفحة المراهقة</title>
    <!-- Bootstrap 5 RTL -->
        ...
        <div class="container-fluid px-3">
            <div class="navbar-inner">
                ...
                <div class="nav-center">
                    ...
                    <span class="color-dot active-dot" style="background:linear-gradient(135deg, #A855F7 0%, #06B6D4 50%, #F472B6 100%);" data-theme="neon" onclick="changeTeenTheme(this)"
                        title="Neon"></span>
                    <span class="color-dot" style="background:linear-gradient(135deg, #3B82F6 0%, #60A5FA 50%, #22C55E 100%);" data-theme="electric" onclick="changeTeenTheme(this)"
                        title="Electric"></span>
                    <span class="color-dot" style="background:linear-gradient(135deg, #F97316 0%, #A855F7 50%, #EC4899 100%);" data-theme="creative" onclick="changeTeenTheme(this)"
                        title="Creative"></span>
                    <span class="color-dot" style="background:linear-gradient(135deg, #4C1D95 0%, #7C3AED 50%, #22D3EE 100%);" data-theme="cosmic" onclick="changeTeenTheme(this)"
                        title="Cosmic"></span>
                </div>
    ...
    <section class="profile-cover">
        ...
        <div class="cover-profile-info">
            <div class="cover-profile-text">
                ...
                <p class="cover-bio" data-translate="profileBio">شاب طموح يسعى لاكتشاف شغفه وبناء مستقبله</p>
            </div>
                            ...
                            <div class="home-events-section">
                                ...
                                <div class="events-list">
                                    ...
                                    <div class="event-card scroll-reveal" data-event-year="2024" data-evt-title="أول يوم في الروضة" data-evt-type="تعليم" data-evt-badge="تعليم"
                                        data-evt-badge-class="evt-education" data-evt-stage="5 سنوات" data-evt-day="الأحد" data-evt-date="1-9-2024" data-evt-time="7:30 صباحاً"
                                    ...
                                    <div class="event-card scroll-reveal" data-event-year="2025" data-evt-title="حفل تخرج الروضة" data-evt-type="تخرج" data-evt-badge="إنجاز"
                                        data-evt-badge-class="evt-milestone" data-evt-stage="6 سنوات" data-evt-day="الخميس" data-evt-date="1-9-2024" data-evt-time="6:00 مساءً"
                                    ...
                                    <div class="event-card scroll-reveal" data-event-year="2026" data-evt-title="أول يوم في المدرسة الابتدائية" data-evt-type="تعليم" data-evt-badge="بداية جديدة"
                                        data-evt-badge-class="evt-education" data-evt-stage="6 سنوات" data-evt-day="الأحد" data-evt-date="1-9-2024" data-evt-time="6:45 صباحاً"
                            ...
                            <div class="certificates-section">
                                ...
                                <div class="certificates-grid" id="certificatesGrid">
                                    ...
                                    <div class="cert-card-wrap scroll-reveal" data-cert-title="شهادة التخرج من الروضة" data-cert-place="روضة الأزهار - الرياض"
                                        ...
                                        data-cert-day="الخميس" data-cert-date="20 يونيو 2024" data-cert-time="6:00 مساءً" data-cert-badge="تخرج"
                                    ...
                                    <div class="cert-card-wrap scroll-reveal" data-cert-title="شهادة حفظ القرآن" data-cert-place="حلقات مسجد الراجحي - الرياض"
                                        ...
                                        data-cert-day="الجمعة" data-cert-date="10-5-1999" data-cert-time="بعد صلاة الجمعة" data-cert-badge="تكريم"
                                        ...
                                        <div class="edu-year-body">
                                            ...
                                            <div class="edu-year-events">
                                                <div class="edu-event-item" data-event-type="تكريم" data-event-title="طفل الشهر"
                                                    data-event-details="اختاره المعلمون لأسلوبه الرائع في التعامل مع زملائه وحرصه على المشاركة في الأنشطة الصفية." data-event-date="28/12/2023"
                            ...
                            <div class="events-section">
                                ...
                                <div class="events-list" id="eventsList">
                                    ...
                                    <div class="event-card scroll-reveal" data-event-year="2020" data-evt-title="التطعيمات الأساسية الكاملة" data-evt-type="طبي" data-evt-badge="صحة"
                                        data-evt-badge-class="evt-medical" data-evt-stage="سنة واحدة" data-evt-day="الثلاثاء" data-evt-date="8 أبريل 2020" data-evt-time="10:00 صباحاً"
                                    ...
                                    <div class="event-card scroll-reveal" data-event-year="2022" data-evt-title="حفل عيد الميلاد الثالث" data-evt-type="احتفال" data-evt-badge="اجتماعي"
                                        data-evt-badge-class="evt-social" data-evt-stage="3 سنوات" data-evt-day="السبت" data-evt-date="22 يوليو 2022" data-evt-time="5:00 مساءً"
                                    ...
                                    <div class="event-card scroll-reveal" data-event-year="2023" data-evt-title="أول رحلة إلى البحر" data-evt-type="رحلة" data-evt-badge="عائلي"
                                        data-evt-badge-class="evt-family" data-evt-stage="4 سنوات" data-evt-day="الخميس" data-evt-date="12 سبتمبر 2023" data-evt-time="طوال اليوم"
