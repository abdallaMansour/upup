...
<head>
    ...
    <title data-translate="pageTitle" data-content-ar="مرحلة البلوغ - {{ $stage->name_ar ?? $stage->name_en ?? '' }}" data-content-en="Adulthood Page - {{ $stage->name_en ?? $stage->name_ar ?? '' }}">{{ $stage->name }}</title>
    <!-- Bootstrap 5 RTL -->
