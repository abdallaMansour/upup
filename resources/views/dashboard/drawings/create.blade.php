...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <h4 class="mb-0">إضافة رسم</h4>
        <a href="{{ ($stage ?? null) ? route('dashboard.my-pages.documents', $stage) : route('dashboard.drawings.index') }}" class="btn btn-label-secondary">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('dashboard.drawings.store', ($stage ?? null) ? ['stage' => $stage->id] : []) }}" method="POST" enctype="multipart/form-data">
                @csrf
