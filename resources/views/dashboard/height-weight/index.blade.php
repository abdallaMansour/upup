...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        ...
        <a href="{{ route('dashboard.height-weight.create') }}" class="btn btn-primary">
        ...
        <div class="card-body">
            @if ($records->isEmpty())
                <div class="text-center py-5 text-muted">
                    ...
                    <p class="mb-0">لا توجد سجلات. <a href="{{ route('dashboard.height-weight.create') }}">أضف أول سجل</a></p>
                </div>
            @else
