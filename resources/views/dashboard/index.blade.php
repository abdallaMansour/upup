...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        {{-- عداد تاريخ إنتهاء الإشتراك للمستخدمين فقط --}}
        @if (auth('web')->check())
            @php
            ...
            @elseif ($subscription && $expiresAt && $expiresAt->isPast())
                <div class="alert alert-warning d-flex align-items-center gap-2 mb-4" role="alert">
                    ...
                    <div class="flex-grow-1">
                        <strong>{{ __('dashboard.subscription_countdown.expired') }}</strong>
                    </div>
                    <a href="{{ route('dashboard.packages.index') }}" class="btn btn-sm btn-warning">{{ __('dashboard.subscription_countdown.renew') }}</a>
                </div>
            @endif
        @endif
        ...
        @if (auth('web')->check())
            ...
            <div class="row g-4">
                ...
                {{-- صفحاتي - مراحل الطفولة المتعددة --}}
                <div class="col-6 col-md-4 col-lg-3">
                    <a href="{{ route('dashboard.my-pages.index') }}" class="card h-100 text-decoration-none border shadow-sm">
                        <div class="card-body text-center">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="education_stage_id" id="education_stage_id" class="form-select @error('education_stage_id') is-invalid @enderror">
                                        ...
                                        @foreach ($educationStages ?? [] as $stage)
                                            <option value="{{ $stage->id }}" {{ old('education_stage_id', optional(auth()->user())->education_stage_id) == $stage->id ? 'selected' : '' }}>
                                                {{ $stage->name }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="education_grade_id" id="education_grade_id" class="form-select @error('education_grade_id') is-invalid @enderror">
                                        ...
                                        @if ($selectedStage)
                                            @foreach ($selectedStage->grades as $grade)
                                                <option value="{{ $grade->id }}" {{ old('education_grade_id', optional(auth()->user())->education_grade_id) == $grade->id ? 'selected' : '' }}>
                                                    {{ $grade->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                            ...
                                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap p-0">
                                                <div class="d-flex flex-wrap align-items-center">
                                                    <ul class="list-unstyled users-list d-flex align-items-center avatar-group m-0 me-2">
                                                        ...
                                                        <li class="avatar">
                                                            <span class="avatar-initial rounded-circle pull-up text-heading" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                                title="3 more">+3</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-between align-items-center gap-4">
                                                        <div class="progress w-100" style="height: 10px">
                                                            <div class="progress-bar bg-info" role="progressbar" style="width: 8.37%" aria-valuenow="8.37" aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-between align-items-center gap-4">
                                                        <div class="progress w-100" style="height: 10px">
                                                            <div class="progress-bar bg-warning" role="progressbar" style="width: 6.12%" aria-valuenow="6.12" aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-between align-items-center gap-4">
                                                        <div class="progress w-100" style="height: 10px">
                                                            <div class="progress-bar bg-danger" role="progressbar" style="width: 2.12%" aria-valuenow="1.94" aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-between align-items-center gap-4">
                                                        <div class="progress w-100" style="height: 10px">
                                                            <div class="progress-bar bg-danger" role="progressbar" style="width: 20.14%" aria-valuenow="1.94" aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-between align-items-center gap-4">
                                                        <div class="progress w-100" style="height: 10px">
                                                            <div class="progress-bar bg-info" role="progressbar" style="width: 12.82%" aria-valuenow="12.82" aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-between align-items-center gap-4">
                                                        <div class="progress w-100" style="height: 10px">
                                                            <div class="progress-bar bg-danger" role="progressbar" style="width: 2.76%" aria-valuenow="2.76" aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-between align-items-center gap-4">
                                                        <div class="progress w-100" style="height: 10px">
                                                            <div class="progress-bar bg-danger" role="progressbar" style="width: 20.14%" aria-valuenow="2.76" aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                        <small class="fw-medium">20.14%</small>
                                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-between align-items-center gap-4">
                                                        <div class="progress w-100" style="height: 10px">
                                                            <div class="progress-bar bg-info" role="progressbar" style="width: 14.82%" aria-valuenow="14.82" aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-between align-items-center gap-4">
                                                        <div class="progress w-100" style="height: 10px">
                                                            <div class="progress-bar bg-danger" role="progressbar" style="width: 7.11%" aria-valuenow="7.11" aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-between align-items-center gap-4">
                                                        <div class="progress w-100" style="height: 10px">
                                                            <div class="progress-bar bg-danger" role="progressbar" style="width: 15.13%" aria-valuenow="7.11" aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
