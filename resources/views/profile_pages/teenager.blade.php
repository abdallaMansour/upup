...
<head>
    ...
    <title data-translate="pageTitle" data-content-ar="صفحة المراهقة - {{ $stage->name_ar ?? $stage->name_en ?? '' }}" data-content-en="Teenager Page - {{ $stage->name_en ?? $stage->name_ar ?? '' }}">{{ $stage->name }}</title>
    <!-- Bootstrap 5 RTL -->
    ...
    <section class="profile-cover">
        ...
        <div class="cover-profile-info">
            <div class="cover-profile-text">
                ...
                @else
                    <p class="cover-bio" data-content-ar="شاب طموح يسعى لاكتشاف شغفه وبناء مستقبله" data-content-en="An ambitious youth seeking to discover his passion and build his future">شاب طموح يسعى لاكتشاف شغفه وبناء مستقبله</p>
                @endif
            </div>
