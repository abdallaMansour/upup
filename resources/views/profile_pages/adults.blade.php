...
<head>
    ...
    <title data-translate="pageTitle" data-content-ar="مرحلة البلوغ - {{ $stage->name_ar ?? ($stage->name_en ?? '') }}" data-content-en="Adulthood Page - {{ $stage->name_en ?? ($stage->name_ar ?? '') }}">
        {{ $stage->name }}</title>
    <!-- Bootstrap 5 RTL -->
...
<body>
    ...
    <section class="profile-cover">
        ...
        <div class="cover-profile-info">
            <div class="cover-profile-text">
                ...
                @else
                    <p class="cover-bio" data-content-ar="النضج والحكمة في رحلة الحياة" data-content-en="Maturity and wisdom in life's journey">النضج والحكمة في رحلة الحياة</p>
                @endif
            </div>
    ...
    <section class="main-content">
                        ...
                        <div class="tab-panel active" id="tab-home">
                            ...
                            <div class="home-events-section">
                                <div class="home-events-header">
                                    ...
                                    <a href="#tab-info" class="home-events-viewall" id="homeViewAllEvents"><i class="fas fa-arrow-left"></i> <span data-translate="viewAllEvents">عرض
                                            الكل</span></a>
                                </div>
                                                ...
                                                <div class="event-card-body">
                                                    <div class="event-meta-tags">
                                                        ...
                                                        @if ($stage->age_in_years)
                                                            <span class="event-meta-tag"><i class="fas fa-child"></i> {{ $stage->age_in_years }} <span
                                                                    data-translate="unitYears">سنوات</span></span>
                                                        @endif
                                                    </div>
                                                    <h4 class="event-card-title" data-content-ar="{{ $evt->title_ar ?? $evt->title }}" data-content-en="{{ $evt->title_en ?? $evt->title }}">
                                                        {{ $evt->title }}</h4>
                                                    <p class="event-card-desc" data-content-ar="{{ Str::limit($evt->desc_ar ?? '', 80) ?: $evt->title_ar ?? $evt->title }}"
                                                        data-content-en="{{ Str::limit($evt->desc_en ?? '', 80) ?: $evt->title_en ?? $evt->title }}">
                                                        {{ Str::limit($evt->desc, 80) ?: $evt->title }}</p>
                                    ...
                                    <div class="birth-info-grid" id="birthInfoGrid">
                                        <div class="birth-info-item">
                                            ...
                                            <div class="birth-info-detail">
                                                ...
                                                <span class="birth-info-value" id="birthNameVal" data-content-ar="{{ $stage->name_ar ?? '' }}"
                                                    data-content-en="{{ $stage->name_en ?? '' }}">{{ $stage->name }}</span>
                                            </div>
                                        </div>
                                        @if ($stage->birth_date)
                                            <div class="birth-info-item">
                                        ...
                                        @if ($stage->birth_place)
                                            <div class="birth-info-item">
                                                ...
                                                <div class="birth-info-detail">
                                                    ...
                                                    <span class="birth-info-value" id="birthPlaceVal" data-content-ar="{{ $stage->birth_place_ar ?? '' }}"
                                                        data-content-en="{{ $stage->birth_place_en ?? '' }}">{{ $stage->birth_place }}</span>
                                                </div>
                                            </div>
                                        @endif
                                        @if ($stage->blood_type)
                                        ...
                                        @if ($stage->father_name)
                                            <div class="birth-info-item">
                                                ...
                                                <div class="birth-info-detail">
                                                    ...
                                                    <span class="birth-info-value" data-content-ar="{{ $stage->father_name_ar ?? '' }}"
                                                        data-content-en="{{ $stage->father_name_en ?? '' }}">{{ $stage->father_name }}</span>
                                                </div>
                                            </div>
                                        @endif
                                        @if ($stage->mother_name)
                                            <div class="birth-info-item">
                                                ...
                                                <div class="birth-info-detail">
                                                    ...
                                                    <span class="birth-info-value" data-content-ar="{{ $stage->mother_name_ar ?? '' }}"
                                                        data-content-en="{{ $stage->mother_name_en ?? '' }}">{{ $stage->mother_name }}</span>
                                                </div>
                                            </div>
                                        @endif
                                        @if ($stage->doctor)
                                            <div class="birth-info-item">
                                                ...
                                                <div class="birth-info-detail">
                                                    ...
                                                    <span class="birth-info-value" data-content-ar="{{ $stage->doctor_ar ?? '' }}"
                                                        data-content-en="{{ $stage->doctor_en ?? '' }}">{{ $stage->doctor }}</span>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                                ...
                                <div class="height-summary scroll-reveal">
                                    <div class="summary-card summary-card-pink">
                                        ...
                                        <div class="summary-info">
                                            ...
                                            <span class="summary-value" id="latestHeightVal">
                                                @if ($latestHeight)
                                                    {{ $latestHeight }}
                                                <span data-translate="unitCm">سم</span>@else-
                                                @endif
                                            </span>
                                        </div>
                                    </div>
                                    <div class="summary-card summary-card-blue">
                                        ...
                                        <div class="summary-info">
                                            ...
                                            <span class="summary-value" id="latestWeightVal">
                                                @if ($latestWeight)
                                                    {{ $latestWeight }}
                                                <span data-translate="unitKg">كج</span>@else-
                                                @endif
                                            </span>
                                        </div>
                                    </div>
                                                ...
                                                <div class="measurement-day">
                                                    ...
                                                    @if ($hw->created_at)
                                                        <div class="measurement-note" style="font-size:0.7rem;color:#888;margin-top:4px">
                                                            <i class="fas fa-edit" style="margin-left:4px;color:#aaa"></i> <span data-translate="recordedAt">تم التسجيل:</span>
                                                            {{ $arDays[$hw->created_at->dayOfWeek] ?? '' }}
                                                            {{ $hw->created_at->format('d-m-Y') }} – {{ $hw->created_at->format('g:i') }}@if ($hw->created_at->hour < 12)
                                                            <span data-translate="timeAm"> صباحاً</span>@else<span data-translate="timePm"> مساءً</span>
                                                            @endif
                                                        </div>
                                                    @endif
                                                </div>
                                    ...
                                    <div class="certificates-grid" id="certificatesGrid">
                                        @forelse($stage->achievements as $ach)
                                            @php
                                                ...
                                                $photos = $ach->mediaItems
                                                    ->map(fn($m) => $m->userDocument ? route('profile.document.embed', [$stage, $m->userDocument]) : null)
                                                    ->filter()
                                                    ->values()
                                                    ->all();
                                            ...
                                            <div class="cert-card-wrap scroll-reveal" data-cert-title="{{ $ach->title }}" data-cert-place="{{ $ach->place ?? '' }}"
                                                ...
                                                <div class="cert-card">
                                                    <div class="cert-thumbnail">
                                                        ...
                                                        @else
                                                            <div
                                                                ...
                                                                <i class="fas fa-certificate" style="font-size:3rem;color:#bbb"></i>
                                                            </div>
                                                        @endif
                                                    ...
                                                    <div class="cert-card-body">
                                                        ...
                                                        @endif
                                                        <h4 class="cert-title"><i class="fas fa-graduation-cap" style="color:#7c4dff;margin-left:6px"></i> <span
                                                                data-content-ar="{{ $ach->title_ar ?? '' }}" data-content-en="{{ $ach->title_en ?? '' }}">{{ $ach->title }}</span></h4>
                                                        @if ($ach->place)
                                                            <p class="cert-place"><i class="fas fa-map-marker-alt"></i> <span data-content-ar="{{ $ach->place_ar ?? '' }}"
                                                                    data-content-en="{{ $ach->place_en ?? '' }}">{{ $ach->place }}</span></p>
                                                        @endif
                            ...
                            <div class="sidebar-body">
                                ...
                                @if ($stage->birth_place)
                                    <div class="info-row">
                                        ...
                                        <div class="info-text">
                                            <span class="info-value" data-content-ar="{{ $stage->birth_place_ar ?? '' }}"
                                                data-content-en="{{ $stage->birth_place_en ?? '' }}">{{ $stage->birth_place }}</span>
                                ...
                                @if ($latestAchievement?->school)
                                    <div class="info-row">
                                        ...
                                        <div class="info-text">
                                            <span class="info-value" data-content-ar="{{ $latestAchievement->school_ar ?? '' }}"
                                                data-content-en="{{ $latestAchievement->school_en ?? '' }}">{{ $latestAchievement->school }}</span>
        ...
        <script>
            window.stageTheme = @json($stage->theme);
            window.stageDefaultLang = @json($stage->default_language);
        </script>
