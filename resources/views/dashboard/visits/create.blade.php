...
<div class="container-xxl flex-grow-1 container-p-y">
    @include('dashboard.partials.breadcrumb', [
        'items' => ($stage ?? null)
            ? [
                ...
                ['label' => __('documents.visits'), 'url' => route('dashboard.visits.index', ['stage' => $stage->id])],
    ...
    <h4 class="mb-4">{{ __('documents.visit_add_title') }}</h4>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('dashboard.visits.store', ($stage ?? null) ? ['stage' => $stage->id] : []) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-12">
                        ...
                        <small class="text-muted">{{ __('documents.visit_supported_formats') }}</small>
                        @error('media')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
