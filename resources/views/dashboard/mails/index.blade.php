                                ...
                                <div class="d-flex align-items-center w-100">
                                    ...
                                    <div class="mb-4 w-100">
                                        <div class="input-group input-group-merge shadow-none">
                                            ...
                                            <input type="text" class="form-control email-search-input border-0 py-0" placeholder="Search mail" aria-label="Search mail"
                            ...
                            <div class="d-flex justify-content-between align-items-center ps-1">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="btn btn-icon me-1">
                                        <i class="icon-base bx bx-trash icon-md email-list-delete cursor-pointer"></i>
                                    </div>
                                    <div class="btn btn-icon me-1">
                                        <i class="icon-base bx bx-envelope-open icon-md email-list-read cursor-pointer"></i>
                                    </div>
                    ...
                    <div class="card shadow-none border-0 rounded-0 app-email-view-header p-5 pt-md-4 py-2">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center overflow-hidden">
                                <span class="ms-sm-2 me-4"><i class="icon-base bx bx-chevron-left icon-md cursor-pointer scaleX-n1-rtl" data-bs-toggle="sidebar"
                        ...
                        <div class="modal-header py-3 justify-content-between">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <button type="button" class="btn btn-sm btn-icon">
                                    <i class="icon-base bx bx-minus icon-20px"></i>
                                </button>
                                <button type="button" class="btn btn-sm btn-icon" data-bs-dismiss="modal" aria-label="Close">
                                    <i class="icon-base bx bx-x icon-20px"></i>
                                </button>
                            </div>
                        </div>
                        <div class="modal-body flex-grow-1 pb-sm-0 px-6 py-2">
                            <form class="email-compose-form">
                                ...
                                <div class="email-compose-actions d-flex justify-content-between align-items-center my-4">
                                    <div class="d-flex align-items-center">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-primary dropdown-toggle email-send-btn" data-bs-toggle="dropdown" aria-expanded="false">
                                                Send <i class="icon-base bx bx-paper-plane icon-sm scaleX-n1-rtl ms-2"></i>
                                            </button>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <button type="reset" class="btn btn-sm btn-icon" data-bs-dismiss="modal" aria-label="Close">
                                            <i class="icon-base bx bx-trash icon-20px"></i>
                                        </button>
                                    </div>
                                </div>
                            </form>
